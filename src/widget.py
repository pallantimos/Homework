...
def mask_account_card(account_card) -> str:
    """ "Функция принимает номер карты или номер счета, далее шифрует и возвращает маску"""
...
def get_date(date: str) -> str:
    """ "Функция принимает дату в формате 2024-03-11T02:26:18.671407 и возвращает в формате ДД.ММ.ГГГГ"""
